...
maven_apps="fuseki harvester harvester-api nginx-search nginx-registration reference-data registration-api registration-auth api-cat concept-cat search-api elasticsearch-copy"
