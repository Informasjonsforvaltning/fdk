...
docker_apps="e2e search registration-react fuseki nginx-registration nginx-altinn-proxy nginx-altinn-proxy-mock nginx-enhetsregisteret-proxy nginx-enhetsregisteret-proxy-mock"
