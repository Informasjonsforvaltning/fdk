...
docker_apps="e2e search registration-react fuseki nginx-registration nginx-search nginx-altinn-proxy nginx-enhetsregisteret-proxy sso sso-idporten-mock"
