...
services="elasticsearch fuseki registration registration-react registration-auth registration-api registration-validator gdoc harvester harvester-api search search-old search-api nginx nginx-registration nginx-search"
