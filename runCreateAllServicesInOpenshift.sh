...
services="elasticsearch fuseki reference-data registration-react registration-auth registration-api harvester harvester-api search api-cat search-api nginx-registration nginx-search"
