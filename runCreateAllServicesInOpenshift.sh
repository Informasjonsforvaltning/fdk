...
services="elasticsearch fuseki registration-react registration-auth registration-api harvester harvester-api search search-api nginx-registration nginx-search"
