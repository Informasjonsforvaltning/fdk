...
components="fuseki harvester harvester-api nginx nginx-registration nginx-search reference-data registration registration-react registration-api registration-auth registration-validator search search-api"
