...
echo "RECORDS_OF_PROCESSING_ACTIVITIES_GUI_HOST=$RECORDS_OF_PROCESSING_ACTIVITIES_GUI_HOST"
...
echo "DEV_RECORDS_OF_PROCESSING_ACTIVITIES_GUI_HOST=$DEV_RECORDS_OF_PROCESSING_ACTIVITIES_GUI_HOST"
...
sed -e 's,${IDPORTEN_CLIENT_ID},'$IDPORTEN_CLIENT_ID',g' \
 ...
 -e 's,${RECORDS_OF_PROCESSING_ACTIVITIES_GUI_HOST},'$RECORDS_OF_PROCESSING_ACTIVITIES_GUI_HOST',g' \
