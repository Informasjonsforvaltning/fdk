...
public class ElasticsearchService {
    ...
    public ApiDocument getApiDcoumentBySpecUrl(String apiSpecUrl) {
        ...
        if (hits.length == 1) {
            ...
            throw new RuntimeException("Lookup of apiSpecUrl returned more than one result. Acutal " + hits.length);
        }
