...
public class DatasetRegistrationMigration {
    ...
    private final Map<String, String> uriConversionMap = Stream.of(new String[][]{
        {"", "0"},//remove also empty uris, it is unknown where they came from
        ...
        {"http://psi.norge.no/los/ord/arbeidstid", "http://psi.norge.no/los/3/ord/arbeidsavtale"},
        {"http://psi.norge.no/los/ord/arv-og-gaver", "http://psi.norge.no/los/3/tema/dodsfall-og-gravferd"},
        {"http://psi.norge.no/los/ord/avlastningsbolig", "http://psi.norge.no/los/3/ord/omsorgsavlastning"},
        {"http://psi.norge.no/los/ord/avlastningshjem", "http://psi.norge.no/los/3/ord/omsorgsavlastning"},
        {"http://psi.norge.no/los/ord/avloepshaandtering", "http://psi.norge.no/los/3/ord/vann-og-avlop"},
        {"http://psi.norge.no/los/ord/avloesertilskudd", "http://psi.norge.no/los/3/ord/avlosertilskudd"},
        {"http://psi.norge.no/los/ord/baalbrenning", "http://psi.norge.no/los/3/ord/balbrenning"},
        {"http://psi.norge.no/los/ord/baatfoererbevis", "http://psi.norge.no/los/3/ord/batforerbevis"},
        {"http://psi.norge.no/los/ord/baatplass", "http://psi.norge.no/los/3/ord/batplass"},
        {"http://psi.norge.no/los/ord/baatsertifikat", "http://psi.norge.no/los/3/ord/fritidsskippersertifikat"},
        {"http://psi.norge.no/los/ord/barnepark", "http://psi.norge.no/los/3/tema/barnehage"},
        {"http://psi.norge.no/los/ord/bebyggelsesplan", "http://psi.norge.no/los/3/ord/reguleringsplan"},
        {"http://psi.norge.no/los/ord/bedriftsetablering", "http://psi.norge.no/los/3/ord/starte-eller-avslutte-bedrift"},
        {"http://psi.norge.no/los/ord/besoekshjem", "http://psi.norge.no/los/ord/besokshjem"},
        {"http://psi.norge.no/los/ord/bompenger", "http://psi.norge.no/los/3/ord/bominformasjon"},
        {"http://psi.norge.no/los/ord/bostoette", "http://psi.norge.no/los/3/ord/bostotte"},
        {"http://psi.norge.no/los/ord/brannvern-og-eksplosjonsvern", "http://psi.norge.no/los/3/tema/brann"},
