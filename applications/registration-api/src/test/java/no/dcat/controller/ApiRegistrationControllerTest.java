...
public class ApiRegistrationControllerTest {
  ...
  @Mock private ApiCatService mockApiCatService;
  
  @Mock private ApiCatClient mockApiCatClient;
  ...
  public void createApiRegistrationOK() throws Throwable {
    String catalogId = "1234";
    ApiRegistration data = new ApiRegistration();
    data.setPrice("100");

    ApiRegistration apiRegistration = ApiRegistrationFactory.createApiRegistration(catalogId, data);
    ApiRegistration actual = saveApiRegistration(catalogId, apiRegistration);
  ...
  private ApiRegistration saveApiRegistration(
    ...
    return apiRegistrationController.createApiRegistration(catalogId, apiRegistration);
  }
}
