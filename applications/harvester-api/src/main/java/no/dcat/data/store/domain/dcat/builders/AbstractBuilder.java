...
import no.dcat.data.store.domain.dcat.Contact;
import no.dcat.data.store.domain.dcat.PeriodOfTime;
import no.dcat.data.store.domain.dcat.Publisher;
import no.dcat.data.store.domain.dcat.vocabulary.DCAT;
import no.dcat.data.store.domain.dcat.vocabulary.EnhetsregisteretRDF;
import no.dcat.data.store.domain.dcat.vocabulary.Vcard;
