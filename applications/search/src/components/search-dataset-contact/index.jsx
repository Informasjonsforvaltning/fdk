        ...
        <div className="row fdk-row">
            ...
            <div className="fdk-container-detail">
              ...
              <div className="fdk-detail-text">
                <p className="fdk-ingress fdk-margin-bottom-no">
                  <a href="#">Bakgrunnsinformasjon om datasettet <i className="fa fa-external-link" aria-hidden="true" /></a>
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-12 fdk-padding-no">
            <div className="fdk-container-detail">
              ...
              <div className="fdk-detail-text">
                <p className="fdk-ingress fdk-margin-bottom-no">
                  <a href="#">Ta kontakt med avdeling for digitalisering <i className="fa fa-external-link" aria-hidden="true" /></a>
                </p>
              </div>
            </div>
          </div>
