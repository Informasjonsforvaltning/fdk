...
(function(window, undefined) {
            ...
            if (request.readyState == 4) {
              ...
              if (status >= 200 && status < 300) {
                ...
                if (onDeny) {
                  ...
                  console.error(
                    'Authorization request was denied by the server.'
                  );
                }
              } else if (onError) {
                onError();
          ...
          if (metadata) {
            ...
            if (metadata.responsePermissionsLimit) {
              params += `&response_permissions_limit=${
                metadata.responsePermissionsLimit
              }`;
            }
          }
  ...
  if (
    ...
    if (typeof define === 'function' && define.amd) {
      define('keycloak-authorization', [], () => KeycloakAuthorization);
    }
  }
})(window);
