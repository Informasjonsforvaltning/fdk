export default {
    ...
    hits: [
        ...
        _source: {
          ...
          creator: {
            ...
            sektorkode: {
              ...
              code: '6100',
              prefLabel: { no: 'Statsforvaltningen' }
            },
            valid: true,
          ...
          datasets: [
            {
              ...
              description: {
                nb:
                  'Enhetsregisteret inneholder oversikt over alle registrerte enheter Norge innen næringsliv, offentlig og frivillig sektor. Enhetsregisteret tildeler organisasjonsnummer, og samordner opplysninger om næringsliv og offentlige etater som finnes i ulike offentlige registre.',
                en:
      ...
      },
      {
        ...
        _source: {
          ...
          identifier:
            'https://data-david.github.io/Begrep/begrep/Organisasjonsnummer',
          prefLabel: { no: 'organisasjonsnummer' },
          altLabel: [{ no: 'Orgid' }, { no: 'Orgnr' }],
          definition: {
            no:
              'Et nisifret nummer som tildeles av Enhetsregisteret for en organisasjon som skal operere som en offentlig aktør'
          },
          ...
          datasets: [
            {
              ...
              description: {
                nb:
                  'Akvakulturregisteret inneholder oversikt over akvakulturtillatelser og enkelte vesentlige vedtak knyttet til disse. I tillegg inneholder registeret en oversikt over overføringer, pantsettelser og andre rettigheter som er tinglyst på tillatelsene.'
              }
            },
            {
              ...
              description: {
                nb:
                  'Frivillighetsregisteret har oversikt over lag og foreninger i Norge, og har som formål å forenkle samhandlingen mellom frivillige organisasjoner og offentlig sektor. De som registrerer seg i Frivillighetsregisteret kan delta i grasrotandelen til Norsk Tipping, og motta/få momskompensasjon.',
                en:
                  'Register of clubs and associations. The purpose is to improve and simplify the interaction between NGOs and public authorities. The Registry will ensure systematic information that can strengthen the legitimacy and knowledge of the voluntary activity. Managed by Brønnøysund Registre'
              }
            },
            {
              ...
              description: {
                nb:
                  'Partiregisteret er et register over politiske parti i Norge. Hovedformålet med registeret er å gi part anledning til å skaffe seg enerett på partinavn.'
              }
            },
            {
              ...
              description: {
                nb:
                  'Registeret for utøvere av alternativ behandling inneholder opplysninger om registrerte utøvere og godkjente utøverorganisasjoner. Registeret skal bidra med å vareta pasientvernet og forbrukerrettighetene for den som oppsøker en registrert alternativ behandler. I tillegg skal registeret medvirke til seriøsitet og ordnede forretningsvilkår'
              }
            },
            {
            ...
            },
            {
              ...
              title: {
                nb: 'Løsøreregisteret',
                en: 'Register of Mortgaged Movable Property'
              },
              description: {
                nb:
                  'Løsøreregisteret er et tinglysingsregister for rettigheter og pant i løsøre. En tinglyst rettighet eller pant, gir rettsvern overfor kreditorer. Løsøreregisteret omfatter ikke tinglysning i fast eiendom, skip og luftfartøyer.'
              }
            },
            {
              ...
              description: {
                nb:
                  'Registeret for offentlig støtte (ROFS) er et nasjonalt register for offentlige støttetildelinger som faller inn under EØS-avtalen. Registeret skal gjøre det enklere for offentlige myndigheter, som vurderer å gi offentlig støtte, å få informasjon om foretakene har fått annen offentlig støtte som må tas med i vurderingen.'
              }
            },
            {
  ...
  aggregations: {
    creator: {
      ...
      buckets: [
        { key: 'ukjent', doc_count: 9 },
        { key: 'Brønnøysundregistrene', doc_count: 1 }
      ]
    },
    orgPath: {
      doc_count_error_upper_bound: 0,
      sum_other_doc_count: 0,
      buckets: [
        { key: 'ukjent', doc_count: 9, children: [] },
        {
          key: '/STAT',
          doc_count: 1,
          children: [
