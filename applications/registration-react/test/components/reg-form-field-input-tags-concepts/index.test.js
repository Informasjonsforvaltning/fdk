...
import InputTagsFieldConcepts from "../../../src/components/reg-form-field-input-tags-concepts";

let defaultProps, wrapper, onToggleTitle, handleChange;
  ...
  defaultProps = {
    ...
    input: {
      ...
      "value": [{
        ...
        "creator": {"uri": "http://data.brreg.no/enhetsregisteret/enhet/974760673"},
