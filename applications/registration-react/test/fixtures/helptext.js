export default {
  ...
  helptextItems: {
    ...
    Agent_type: {
      id: 'Agent_type',
      shortdesc: {
        nb: 'Enheter angis med organisasjonstype for å skille mellom offentlige og private datasetteiere.'
      },
      description: {
        nb: 'Enheter angis med organisasjonstype for å skille mellom offentlige og private datasetteiere.'
      },
    ...
    Catalog_description: {
      ...
      shortdesc: {
        nb: 'En kort og presis beskrivelse av datasettet skal gjøre det lett for andre å se hva det inneholder. Beskrivelse er et obligatorisk felt.'
      },
      description: {
        nb: 'En kort og presis beskrivelse av datasettet skal gjøre det lett for andre å se hva det inneholder. Beskrivelse er et obligatorisk felt.'
      },
    ...
    Catalog_modified: {
      id: 'Catalog_modified',
      shortdesc: {
        nb: 'Dato/tid sist katalogen ble endret,. Dette kan være endring av en datasettbeskrivelse, eller andre metadata i katalogen.'
      },
      description: {
        nb: 'Dato/tid sist katalogen ble endret,. Dette kan være endring av en datasettbeskrivelse, eller andre metadata i katalogen.'
      },
    ...
    Catalog_title: {
      id: 'Catalog_title',
      shortdesc: {
        nb: 'Kortfattet om katalogen. Angi, uten å liste, hvilke datasett den omfatter.'
      },
      description: {
        nb: 'Kortfattet om katalogen\n* Angi, uten å liste, hvilke datasett den omfatter, \n* f.eks. datasettene til Brønnøysundregistrene.'
      },
    ...
    ContactPoint_hasEmail: {
      ...
      shortdesc: {
        nb: 'Angi e-postadresse for kontaktpunktet dersom dette er en ønsket kontaktform'
      },
      description: {
        nb: 'Angi e-postadresse for kontaktpunktet dersom dette er en ønsket kontaktform'
      },
    ...
    ContactPoint_hasTelephone: {
      ...
      shortdesc: {
        nb: 'Angi telefonnummer for kontaktpunktet dersom dette er en ønsket kontaktform'
      },
      description: {
        nb: 'Angi telefonnummer for kontaktpunktet dersom dette er en ønsket kontaktform'
      },
    ...
    ContactPoint_hasURL: {
      ...
      shortdesc: {
        nb: 'Angi referanse til kontaktskjema på web dersom dette er en ønsket kontaktform'
      },
      description: {
        nb: 'Angi referanse til kontaktskjema på web dersom dette er en ønsket kontaktform'
      },
    ...
    Dataeset_testdata: {
      ...
      shortdesc: {
        nb: 'For å angi at et register eller datasett foreligger som testdata, typisk syntetiske eller anonymiserte, angis dette med relasjonen testdatasett til et annet datasett. '
      },
      description: {
    ...
    Dataset_distribution: {
      ...
      shortdesc: {
        nb: 'For å angi hvor man kan få tilgang til datasettet skal det angis ulike distribusjoner.'
      },
      description: {
    ...
    Dataset_documentation: {
      ...
      shortdesc: {
        nb: 'Referanse til en side som beskriver utdypende dokumentasjon om datasettet.'
      },
      description: {
        nb: 'Utdypende dokumentasjon av datasettet angis ved å peke på en side der den finnes. Det anbefales at Landingsside brukes i stedet for dokumentasjon.'
      },
    ...
    Dataset_example: {
      id: 'Dataset_example',
      shortdesc: {
        nb: 'Benyttes for å gi eksempeldata for et datasett, og hvordan en faktisk distribusjon ser ut.\n'
      },
      description: {
    ...
    Dataset_hasQualityAnnotation_accuracy: {
      ...
      description: {
        nb: 'I hvilken grad datasettet korrekt representerer intensjonen som er angitt av dataeier i formålet\nNøyaktighet skal tolkes i forhold til formålet. \n'
      },
    ...
    Dataset_hasQualityAnnotation_availability: {
      ...
      shortdesc: {
        nb: 'Avvik eller tilleggsopplysninger knyttet til datasettes tilgjengelighet.'
      },
      description: {
        nb: 'Avvik eller tilleggsopplysninger knyttet til datasettets tilgjengelighet\n* Tilgjengelighet tolkes i forhold til tilgangsnivå og ev. begrensninger utover det som er angitt i behandlingsgrunnlag, skjermings- og utleveringshjemmel.\n* Dersom datasettet er åpent men mangler distribusjoner bør årsaken angis her.\n'
      },
      uri: 'http://brreg.no/fdk/fields#Dataset_hasQualityAnnotation_availability'
    },
    Dataset_hasQualityAnnotation_completeness: {
      id: 'Dataset_hasQualityAnnotation_completeness',
      shortdesc: {
        nb: 'I hvilken grad inneholder datasettet alle objekter som nevnt i formålet'
      },
      description: {
        nb: 'I hvilken grad inneholder datasettet forventede opplysninger\n* Kompletthet tolkes i forhold til formålet (utvalget)\n* Inneholder datasettet de objekter som nevnt i formålet? '
      },
      uri: 'http://brreg.no/fdk/fields#Dataset_hasQualityAnnotation_completeness'
    },
    Dataset_hasQualityAnnotation_currentness: {
      id: 'Dataset_hasQualityAnnotation_currentness',
      shortdesc: {
        nb: 'Avvik eller tilleggsopplysninger om “oppdateringsfrekvens” og “sist oppdatert”'
      },
      description: {
    ...
    Dataset_hasQualityAnnotation_relevance: {
      ...
      shortdesc: {
        nb: 'Avvik eller tilleggsopplysninger knyttet til datasettes relevans i ulike brukskontekster\n'
      },
      description: {
    ...
    Dataset_landingpage: {
      ...
      shortdesc: {
        nb: 'Referanse til en side som beskriver datasettets innhold, struktur og tilgang.'
      },
      description: {
        nb: 'Dokumentasjon om datasettet på en landingsside hos datasetteieren som kan beskrive registeret, innhold og struktur, og tilgang.\n* kan referere til registerets hjemmeside\n* kan referere til en samleside som beskriver innhold og struktur \n* kan referere til en samleside om nedlasting/bruk/søk (tjenestene)\n* det kan refereres til flere sider'
      },
    ...
    Dataset_legalBasisForAccess: {
      ...
      shortdesc: {
        nb: 'Henvisning til regelverk som begrunner en offentlig virksomhet sin rett eller plikt til å utlevere opplysninger til andre private personer eller juridiske personer.'
      },
      description: {
        nb: 'Informasjon om utleveringshjemmel gjør det enklere for brukere av datasettet å se om det er nødvendig med egen hjemmel for innhenting eller om de kan få tillatelse til å bruke opplysninger etter søknad til dataeier.\n* Henvisning til regelverk som begrunner en offentlig virksomhet sin rett eller plikt til å utlevere opplysninger til andre private personer eller juridiske personer.\n* Henvisningen gjøres til lovdata på paragraf-nivå.'
      },
    ...
    Dataset_legalBasisForRestriction: {
      ...
      description: {
        nb: 'Dersom datasettet har begrensninger på deling trenger vi å vite hva skjermingen gjelder. Det kan være hjemmel (kilde for påstand) i offentlighetsloven, sikkerhetsloven, beskyttelsesinstruksen eller annet lovverk som ligger til grunn for vurdering av tilgangsnivå.\n* Angi referanse til relevant lov eller forskrift. Helst til lovdata på paragrafnivå. \n* Egenskapen er anbefalt dersom «tilgangsnivå» har verdiene «begrenset» eller «ikke-offentlig»'
      },
    ...
    Dataset_provenance: {
      ...
      shortdesc: {
        nb: 'Angi om opplysningene i datasettet er resultat av vedtak eller innsamlet fra bruker eller tredjepart'
      },
      description: {
        nb: 'Det er behov for en sortering om innholdet er basert på avgjørelse truffet under utøvelse av offentlig myndighet (vedtak) eller er kommer fra andre kilder (bruker eller tredjepart). Vedtak anses å være autoritative kilder for hele forvaltningen. \n* Angi om opplysningene i datasettet er resultat av vedtak eller innsamlet fra bruker eller tredjepart\n* Det skal velges en verdi fra et kontrollert vokabular med verdiene :Vedtak, :Bruker, :Tredjepart'
      },
    ...
    Dataset_publisher: {
      ...
      description: {
        nb: 'Identifisering av den enheten som er ansvarlig for at datasettet er tilgjengelig, ikke den som faktisk gjør datasettet tilgjengelig. Eier er et obligatorisk felt.\n* Skal peke på en Enhet (juridisk person, organisasjonsledd, underenhet)\n* Det offisielle navnet på virksomheten vil hentes fra Enhetsregisteret, men kortform (f.eks. Difi) kan legges inn av brukeren\n* Eieren av datasettet forvalter sammensetning av dataene, altså datasettet, og ikke nødvendigvis selve dataene. \n'
      },
    ...
    Dataset_relation: {
      id: 'Dataset_relation',
      shortdesc: {
        nb: 'Referanse til andre datasett som gir supplerende informasjon om innholdet, f.eks. et kodeverk.'
      },
      description: {
        nb: 'En generell relasjon som peker til ressurser som er relatert til datasettet.\n\nAngi referanser til andre datasett som gir supplerende informasjon om innholdet. Kan f.eks. være å relatere til et kodeverk.'
      },
    ...
    Dataset_requires: {
      id: 'Dataset_requires',
      shortdesc: {
        nb: 'Peker til en ressurs som må være tilstede for at datasettet skal kunne produseres.'
      },
      description: {
    ...
    Dataset_theme: {
      id: 'Dataset_theme',
      shortdesc: {
        nb: 'Ett eller flere temaer velges fra den kontrollerte listen av EU-temaer'
      },
      description: {
        nb: 'For å kunne sortere datasettet inn under gitte kategorier er det behov for tema\n* Ett eller flere temaer velges fra den kontrollerte listen av EU-temaer.'
      },
    ...
    Dataset_type: {
      id: 'Dataset_type',
      shortdesc: {
        nb: 'Referanse til en klassifisering av datasettets type innhold. Refererer til EU publication office sine datasett-typer'
      },
      description: {
    ...
    Distribution_conformsTo: {
      ...
      shortdesc: {
        nb: 'Benyttes for å angi et etablert skjema som distribusjonen er i samsvar med, for eksempel et XSD-dokument.'
      },
      description: {
        nb: 'Benyttes for å angi et etablert skjema som distribusjonen er i samsvar med, for eksempel et XSD-dokument.'
      },
    ...
    Distribution_documentation: {
      ...
      shortdesc: {
        nb: 'Referanse til en side eller et dokument som beskriver og dokumenterer innhold og struktur spesifikk for distribusjonen.'
      },
      description: {
        nb: 'Referanse til en side eller et dokument som beskriver og dokumenterer innhold og struktur spesifikk for distribusjonen.'
      },
    ...
    Distribution_format: {
      ...
      shortdesc: {
        nb: 'Hver distribusjon har format for utveksling. Format er et obligatorisk felt for en distribusjon.'
      },
      description: {
    ...
    Distribution_issued: {
      ...
      shortdesc: {
        nb: 'Dato/tid når distribusjonen (f.eks. api) først ble publisert i tilknytning til et datasett.'
      },
      description: {
        nb: 'Dato/tid når distribusjonen (f.eks. api) først ble publisert i tilknytning til et datasett. Når innholdet i datasettene ble gjort tilgjengelige. '
      },
    ...
    Distribution_landingpage: {
      ...
      shortdesc: {
        nb: 'Refererer til en nettside som gir tilgang til datasettet, distribusjoner og annen informasjon. '
      },
      description: {
        nb: 'Egenskap ved datasett som refererer til en nettside som gir tilgang til datasettet, distribusjoner og annen informasjon. Skal peke til en side hos den originale tilbyderen av data.\n* kan benyttes for å peke til en samleside om et datasett og dets distribusjoner.\n* bør peke til en side hos den originale tilbyderen av data.'
      },
    ...
    Distribution_modified: {
      ...
      shortdesc: {
        nb: 'DDato/tid sist distribusjonen (API-et, filen eller feeden) sist ble endret.'
      },
      description: {
        nb: 'Dato/tid sist distribusjonen (API-et, filen eller feeden) sist ble endret.'
      },
