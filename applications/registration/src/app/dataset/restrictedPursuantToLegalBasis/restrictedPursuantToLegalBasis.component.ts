...
export class restrictedPursuantToLegalBasisFormComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.restrictedPursuantToLegalBasisForm.valueChanges.debounceTime(40).distinctUntilChanged().subscribe(
            restrictedPursuantToLegalBasisFormElement => {
                this.restrictedPursuantToLegalBasis.prefLabel = { 'nb' : restrictedPursuantToLegalBasisFormElement.prefLabel };
                this.restrictedPursuantToLegalBasis.uri = restrictedPursuantToLegalBasisFormElement.uri;
