...
public class GdocCatalogSteps {
    ...
    @Value("${portal}")
    public static String PORTAL_URL = "http://192.168.99.100:8080"; // = "http://fdk-por-fellesdatakatalog-ut1.ose-npc.brreg.no/"; //"http://portal-fdk.tt1.brreg.no";

    @Value("${admin")
    public static String ADMIN_URL = "http://192.168.99.100:8082"; // = "http://fdk-adm-fellesdatakatalog-ut1.ose-npc.brreg.no/"; //"http://admin-fdk.tt1.brreg.no";

    @Value("${gdoc}")
    public static String GDOC_CONVERT_URL = "http://192.168.99.100:8084"; //  = "http://192.168.99.100:8084/convert";

    @Value("${elasticsearch.host")
    private static String elasticsearch_host = "http://192.168.99.100"; // = "http://elasticsearch-fellesdatakatalog-ut1.ose-npc.brreg.no/";
