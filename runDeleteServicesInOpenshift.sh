...
services="registration-react registration-auth registration-api registration-validator nginx-search nginx-registration gdoc harvester harvester-api search search-api"
