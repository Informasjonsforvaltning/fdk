...
services="registration registration-react registration-auth registration-api registration-validator nginx nginx-search nginx-registration gdoc harvester harvester-api search search-api"
