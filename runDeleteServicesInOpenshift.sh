...
services="registration-react reference-data registration-auth registration-api nginx-search nginx-registration harvester harvester-api search search-api elasticsearch-copy"
