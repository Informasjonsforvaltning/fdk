...
public class ReferenceDataClient {
    ...
    public ReferenceDataClient(String referenceDataHost) {
        this.referenceDataHost = referenceDataHost;
    }

    public Map<String, Map<String, SkosCode>> getAllCodes() {
        return allCodesCacheByCode != null ? allCodesCacheByCode : (allCodesCacheByCode = getAllCodesByCode(referenceDataHost));
    }
