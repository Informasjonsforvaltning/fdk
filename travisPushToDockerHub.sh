...
components="fuseki harvester harvester-api nginx nginx-search reference-data registration-api registration-auth registration-validator search search-old search-api"
toEnvironment=ut1
