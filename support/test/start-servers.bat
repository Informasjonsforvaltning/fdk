...
START /b "test-query" java -Dfile.encoding=UTF-8 -jar lib\query-0.2.4-SNAPSHOT.jar --spring.profiles.active=test --application.elasticsearchHost=localhost --application.elasticsearchPort=9300 --server.port=8071
